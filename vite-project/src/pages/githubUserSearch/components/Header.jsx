  ...
  return (
    <>
      <div className={'flex items-start justify-between mb-5 ' + props.theme}>
        <h1 className="font-bold text-800 m-0 text-3xl">devfinder</h1>
      ...
      <form
        onSubmit={onSearch}
        className="flex justify-between items-center p-2  bg-skin-backgroundLight rounded-2xl shadow-shadow"
      >
