export const Article = () => {
  return (
    <article class="absolute bg-red-500 text-gray-100 p-8 text-base leading-6 text-left top-16 right-20 w-64 rounded-2xl">
      <h2 className="text-4xl leading-10">Premium EQ</h2>
      <p>
      ...
      <p class="m-8">
        <span>$4</span> <sup> / month</sup>
      </p>
      <div class="text-center">
        <button class="w-full p-2 rounded-md font-bold mb-1 cursor-pointer border-none bg-gray-900 text-gray-100 hover:bg-teal-300">
          ...
          <span className="font-bold">iOS Download</span>
        </button>
        <button class="w-full p-2 rounded-md font-bold mb-1 cursor-pointer border-none bg-gray-100 text-gray-900 hover:bg-orange-400">
          ...
          <span className="font-bold">Android Download</span>
        </button>
      </div>
    </article>
  );
